...
group "Dependencies"
   ...
   include "vendor-build/NodeEditor.lua"
...
-- What the engine was actually built with, written down for the SDK to read. Detecting it again
-- on the app's side would answer a different question: whether *that* machine has OpenSSL, not
-- whether the libVAE.a it is linking has the calls compiled into it.
io.writefile("sdk/config.lua", table.concat({
   "-- Generated by premake5 — what this engine build links. Do not edit.",
   "VAE_HAS_OPENSSL = " .. tostring(VaeHasOpenSSL()),
   "VAE_HAS_SDBUS   = " .. tostring(VaeHasSdBus()),
   "",
}, "\n"))
